...
<div class="box-button-columns">
 ...
 <br>
 <div class="box-button-columns">
   <div class="box-button"><a href="#modal-1" role="button" data-modal-open class="panel-2">
       <span><img src="_images/cloud.png" id="cloud-icon">
     <h2>
       Compare
     </h2>
     <p>Compare ThoughtSpot Cloud and Software features.</p></span>
     </a></div>
     </div>
<div class="is-this-helpful-box"><a class="btn btn-outline-primary btn-sm" href="#modal-1" role="button" data-modal-open>Compare ThoughtSpot Cloud and Software features</a></div>
      ...
      <table class="matrix" width="70%" border="0" align="center" font-family="Optimo-Plain,sans-serif;">
        <tbody>
          <tr>
      ...
      <tr>
      <td colspan="3"># Multi-node cluster support in Cloud coming in roadmap 1H CY23.</td>
          </tr>
      <tr>
      <td colspan="3">* Data workspace is GA in Cloud. Coming soon in Software.</td>
          </tr>
      <tr>
